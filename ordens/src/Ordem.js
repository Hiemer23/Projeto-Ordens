...
function Ordem({ Ord, Operacao, Descricao, Equipamento_SAP, Nome_Equipamento, Nome_Local_Instalacao, Horas_Previstas, Data, PM_Responsavel, Classificacao }) {
    let simbolo = ""
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.data_base}>
                <div className={styles.texto1}>Data: {Data}</div>
                <div className={styles.texto4}><BsCheck2Circle /></div>
            </div>
